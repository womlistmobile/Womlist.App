// SarfDetayScreen güncellenmiş versiyonudur
...
export default function SarfDetayScreen() {
  const route = useRoute<RouteProp<RootStackParamList, 'SarfDetay'>>();
  ...
  const handleVeriTransferi = () => {
    ...
    navigation.navigate('SarfEkBilgiler', {
      fisId,
      depoId,
      userId,
    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerText}>Sarf Detay</Text>
        </View>
