...
export default function ZayiScreen() {
  ...
  useEffect(() => {
    const fetchFisler = async () => {
      setLoading(true);
      try {
        const url = `https://apicloud.womlistapi.com/api/SabitFis/FisListesi/${depoId}/4/${hareketTipi}`;
...
const styles = StyleSheet.create({
  ...
  cardTouchable: { marginBottom: 12, borderRadius: 12 },
  card: {
