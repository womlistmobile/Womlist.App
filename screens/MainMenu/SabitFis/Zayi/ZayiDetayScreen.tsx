// ZayiDetayScreen güncellenmiş versiyonudur
...
export default function ZayiDetayScreen() {
  const route = useRoute<RouteProp<RootStackParamList, 'ZayiDetay'>>();
  ...
  const handleVeriTransferi = () => {
    ...
    navigation.navigate('ZayiEkBilgiler', {
      fisId,
      depoId,
      userId,
    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerText}>Zayi Detay</Text>
        </View>
